...
namespace Unity.Tilemaps
{
    ...
    public class RuleMatchSerializable
    {
        ...
        /// <summary>
        ///     The enumeration for the transform rule used when matching Rule Entity Id Tiles.
        /// </summary>
        public enum TransformMatch
        {
            /// <summary>
            ///     The Rule Entity Id Tile will match Tiles exactly as laid out in its neighbors.
            /// </summary>
            Fixed,

            /// <summary>
            ///     The Rule Entity Id Tile will rotate and match its neighbors.
            /// </summary>
            Rotated,

            /// <summary>
            ///     The Rule Entity Id Tile will mirror in the X axis and match its neighbors.
            /// </summary>
            MirrorX,

            /// <summary>
            ///     The Rule Entity Id Tile will mirror in the Y axis and match its neighbors.
            /// </summary>
            MirrorY,

            /// <summary>
            ///     The Rule Entity Id Tile will mirror in the X or Y axis and match its neighbors.
            /// </summary>
            MirrorXY,

            /// <summary>
            ///     The Rule Entity Id Tile will rotate and mirror in the X and match its neighbors.
            /// </summary>
            RotatedMirror
        }
...
#region Output
        ...
        /// <summary>
        /// Transform randomization applied to the Tile output when the Rule matches
        /// </summary>
        public TransformMatch randomTransform;
#endregion
        ...
        public void ToOutput(ref RuleMatchOutput output)
        {
            ...
            output.randomTransform = randomTransform;
    ...
    public struct RuleMatchOutput : IDisposable
    {
        ...
        /// Transform randomization applied to the Tile output when the Rule matches
        /// </summary>
        public RuleMatchSerializable.TransformMatch randomTransform;
