...
namespace Unity.Tilemaps
{
    ...
    public class HexagonalRuleEntityIdTile : RuleEntityIdTile
    {
        ...
        /// <summary>
        ///     Angle in which the HexagonalRuleEntityIdTile is rotated by for matching in Degrees.
        /// </summary>
        ...
        public struct HexagonalRuleEntityIdTileDataStruct : IDisposable
        {
            ...
            /// <summary>
            /// Disposes memory allocations used by HexagonalRuleEntityIdTileDataStruct
            /// </summary>
            public void Dispose()
            {
        ...
        /// <summary>
        ///     Returns whether any TilingRule on this HexagonalRuleEntityIdTile has Animation output.
        /// </summary>
        internal override bool hasAnimationRule => m_Data.hasAnimationRule;

        /// <summary>
        /// The refresh extent of a HexagonalRuleEntityIdTile is the largest absolute neighbor offset
        /// on each axis, derived from the bounds of its neighbor positions. Tilemap adds a further
        /// one-cell X margin to absorb the odd-row hex offset applied when refreshing.
        /// </summary>
            ...
            , ref AffineTransform transform)
        {
            ...
            // Check rule against x-axis mirror with rotations of 0, 60, 120, 180, 240, 300
