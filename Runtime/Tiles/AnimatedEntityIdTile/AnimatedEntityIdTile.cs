...
{
    /// <summary>
    ///     Animated Entity Id Tiles are tiles which run through and display a list of sprites in sequence.
    /// </summary>
    [BurstCompile]
    [Serializable]
    ...
    public class AnimatedEntityIdTile : EntityIdTileBase
    {
        ...
        /// <summary>
        ///     The List of Sprites set for the Animated Entity Id Tile.
        ...
        /// <summary>
        ///     The starting time of this Animated Entity Id Tile.
        ...
        /// <summary>
        ///     The starting frame of this Animated Entity Id Tile.
        ///     This allows you to start the Animation from a particular Sprite in the list of Animated Sprites.
        ///     If this is set, this overrides animationStartTime.
        /// </summary>
        ...
        private void OnValidate()
        {
            ...
            m_Data = new AnimatedEntityIdData()
            {
                ...
                m_Random = new Unity.Mathematics.Random(1 + Convert.ToUInt32(Math.Abs(cachedEntityId.GetHashCode()))) // Random needs to be seeded with a non-zero value
            };
            if (hasAnimatedSprites)
            {
                for (var i = 0; i < m_AnimatedSprites.Length; i++)
