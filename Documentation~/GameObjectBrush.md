...
the [Picker Tool](https://docs.unity3d.com/Manual/tilemaps/tile-palettes/tools/create-brush-picks-from-tiles-pick-tool.html) from
the [Tile Palette](https://docs.unity3d.com/Manual/tilemaps/tile-palettes/tools/paint-tiles-with-paint-tool.html) toolbar. Use
the [Select Tool](https://docs.unity3d.com/Manual/tilemaps/tile-palettes/tools/select-tool/select-tool-landing.html) to select GameObjects from the Scene
...
- It overrides the `BoxFill` method to paint a GameObject in each cell defined by
  the [Box Tool](https://docs.unity3d.com/Manual/tilemaps/tile-palettes/tools/select-tool/select-tool-landing.html).
