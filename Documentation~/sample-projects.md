...
To use the sample projects, [install the 2D Tilemap Extras package](install.md) in your project.
...
Go to the **Tiles** subfolder and drag the **Waterfall** tile to a tile palette, then paint with it. Enter Play mode to display the animation. For more information, refer to [Create an animated tile](AnimatedTile.md).
...
Go to the **Tiles** subfolder and drag one of the **AutoTile** tiles to a tile palette, then paint with it. The tiles are auto tiles that paint different sprites depending on the layout of the surrounding tiles. For more information, refer to [Create an auto tile](AutoTile.md).
