...
{
    /// <summary>
    ///     The Editor for a RuleEntityIdTile.
    /// </summary>
    [CustomEditor(typeof(RuleEntityIdTile), true)]
    [CanEditMultipleObjects]
    [MovedFrom(true, "UnityEditor.Tilemaps.Experimental", "Unity.2D.Tilemap.Editor.Experimental")]
    public class RuleEntityIdTileEditor : Editor
    {
        ...
        private static readonly string k_UndoName = L10n.Tr("Change RuleEntityIdTile");
        ...
        /// <summary>
        ///     Whether the RuleEntityIdTile can extend its neighbors beyond directly adjacent ones
        /// </summary>
        ...
        /// <summary>
        ///     The RuleEntityIdTile being edited
        /// </summary>
        public RuleEntityIdTile tile => target as RuleEntityIdTile;
        ...
        /// <summary>
        ///     OnEnable for the RuleEntityIdTileEditor
        /// </summary>
        public virtual void OnEnable()
        {
            m_ReorderableList = new ReorderableList(tile != null ? tile.m_TilingRules : null,
                typeof(RuleEntityIdTile.TilingRule), true, true, true, true);
        ...
        /// <summary>
        ///     OnDisable for the RuleEntityIdTileEditor
        /// </summary>
        ...
        public virtual BoundsInt GetRuleGUIBounds(BoundsInt bounds, RuleEntityIdTile.TilingRule rule)
        {
            if (extendNeighbor)
            {
                bounds.xMin--;
        ...
        public float GetElementHeight(RuleEntityIdTile.TilingRule rule)
        {
            var bounds = GetRuleGUIBounds(rule.GetBounds(), rule);

            var inspectorHeight = GetElementHeight(rule as RuleEntityIdTile.TilingRuleOutput);
        ...
        public float GetElementHeight(RuleEntityIdTile.TilingRuleOutput rule)
        {
        ...
        /// <summary>
        ///     Gets the GUI matrix size for a Rule of a RuleEntityIdTile
        /// </summary>
        /// <param name="bounds">Cell bounds of the Rule.</param>
        /// <returns>Returns the GUI matrix size for a Rule of a RuleEntityIdTile.</returns>
        ...
        {
            var rule = new RuleEntityIdTile.TilingRule();
            rule.m_Output = RuleMatchSerializable.OutputSprite.Single;
            rule.m_Sprites[0] = tile.defaultSprite;
            rule.m_GameObject = tile.defaultGameObject;
            rule.m_ColliderType = tile.defaultColliderType;

            var count = m_TilingRules.arraySize;
            ResizeRuleEntityIdTileList(count + 1);
        ...
        /// <summary>
        ///     Saves any changes to the RuleEntityIdTile
        /// </summary>
        ...
        /// <summary>
        ///     Updates all RuleOverrideTiles which override the given RuleEntityIdTile
        /// </summary>
        /// <param name="target">RuleEntityIdTile which has been updated</param>
        public static void UpdateAffectedOverrideTiles(RuleEntityIdTile target)
        {
        ...
        /// <summary>
        ///     Gets all RuleOverrideTiles which override the given RuleEntityIdTile
        /// </summary>
        /// <param name="target">RuleEntityIdTile which has been updated</param>
        /// <returns>A list of RuleOverrideTiles which override the given RuleEntityIdTile</returns>
        public static List<RuleOverrideTile> FindAffectedOverrideTiles(RuleEntityIdTile target)
        {
        ...
        /// <summary>
        ///     Draws the Inspector GUI for the RuleEntityIdTileEditor
        /// </summary>
        public override void OnInspectorGUI()
        {
            ...
            tile.defaultSprite =
                EditorGUILayout.ObjectField(Styles.defaultSprite, tile.defaultSprite, typeof(Sprite),
                    false) as Sprite;
            tile.defaultGameObject =
                EditorGUILayout.ObjectField(Styles.defaultGameObject, tile.defaultGameObject, typeof(GameObject),
                    false) as GameObject;
            tile.defaultColliderType =
                (Tile.ColliderType)EditorGUILayout.EnumPopup(Styles.defaultCollider, tile.defaultColliderType);
            ...
            if (EditorGUI.EndChangeCheck())
                ResizeRuleEntityIdTileList(count);
            ...
            if (count == 0)
            {
                ...
                DisplayClipboardText(Styles.emptyRuleEntityIdTileInfo, rect);
        ...
        private void ResizeRuleEntityIdTileList(int count)
        {
            ...
            if (isEmpty)
                for (var i = 0; i < count; ++i)
                    tile.m_TilingRules[i] = new RuleEntityIdTile.TilingRule();
            UpdateTilingRuleIds();
        }

        /// <summary>
        ///     Draw editor fields for custom properties for the RuleEntityIdTile
        /// </summary>
        ...
        /// <summary>
        ///     Gets the index for a Rule with the RuleEntityIdTile to display an arrow.
        /// </summary>
        /// <param name="position">The relative position of the arrow from the center.</param>
        /// <returns>Returns the index for a Rule with the RuleEntityIdTile to display an arrow.</returns>
        ...
        public virtual void RuleOnGUI(Rect rect, Vector3Int position, int neighbor)
        {
            switch (neighbor)
            {
                case RuleEntityIdTile.TilingRuleOutput.Neighbor.This:
                    GUI.DrawTexture(rect, arrows[GetArrowIndex(position)]);
                    break;
                case RuleEntityIdTile.TilingRuleOutput.Neighbor.NotThis:
        ...
        public virtual void RuleTransformOnGUI(Rect rect, RuleMatchSerializable.TransformMatch ruleTransform)
        {
            switch (ruleTransform)
            {
                case RuleMatchSerializable.TransformMatch.Rotated:
                    GUI.DrawTexture(rect, autoTransforms[0]);
                    break;
                case RuleMatchSerializable.TransformMatch.MirrorX:
                    GUI.DrawTexture(rect, autoTransforms[1]);
                    break;
                case RuleMatchSerializable.TransformMatch.MirrorY:
                    GUI.DrawTexture(rect, autoTransforms[2]);
                    break;
                case RuleMatchSerializable.TransformMatch.Fixed:
                    GUI.DrawTexture(rect, autoTransforms[3]);
                    break;
                case RuleMatchSerializable.TransformMatch.MirrorXY:
                    GUI.DrawTexture(rect, autoTransforms[4]);
                    break;
                case RuleMatchSerializable.TransformMatch.RotatedMirror:
        ...
        public void RuleNeighborUpdate(Rect rect, RuleEntityIdTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors,
            Vector3Int position)
        {
        ...
        public void RuleTransformUpdate(Rect rect, RuleEntityIdTile.TilingRule tilingRule)
        {
            if (Event.current.type == EventType.MouseDown && ContainsMousePosition(rect))
            {
                tilingRule.m_RuleTransform = (RuleMatchSerializable.TransformMatch)(int)Mathf.Repeat(
                    (int)tilingRule.m_RuleTransform + GetMouseChange(),
                    Enum.GetValues(typeof(RuleMatchSerializable.TransformMatch)).Length);
                GUI.changed = true;
                Event.current.Use();
            }
        }
        ...
        /// <summary>
        ///     Draws a Rule Matrix for the given Rule for a RuleEntityIdTile.
        /// </summary>
        ...
        public virtual void RuleMatrixOnGUI(RuleEntityIdTile tile, Rect rect, BoundsInt bounds, RuleEntityIdTile.TilingRule tilingRule)
        {
        ...
        /// <summary>
        ///     Draws a Rule Matrix Icon for the given matching Rule for a RuleEntityIdTile with the given position
        /// </summary>
        /// <param name="tilingRule">Tile to draw rule for.</param>
        /// <param name="neighbors">A dictionary of neighbors</param>
        /// <param name="position">The relative position of the neighbor matching Rule</param>
        /// <param name="rect">GUI Rect to draw icon at</param>
        public void RuleMatrixIconOnGUI(RuleEntityIdTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors,
        ...
        public virtual void SpriteOnGUI(Rect rect, RuleEntityIdTile.TilingRuleOutput tilingRule)
        {
        ...
        public void RuleInspectorOnGUI(Rect rect, RuleEntityIdTile.TilingRuleOutput tilingRule)
        {
            var y = rect.yMin;
            ...
            tilingRule.m_Output = (RuleMatchSerializable.OutputSprite)EditorGUI.EnumPopup(
                new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight),
                tilingRule.m_Output);
            y += k_SingleLineHeight;

            if (tilingRule.m_Output == RuleMatchSerializable.OutputSprite.Animation)
            {
            ...
            if (tilingRule.m_Output == RuleMatchSerializable.OutputSprite.Random)
            {
                ...
                tilingRule.m_RandomTransform = (RuleMatchSerializable.TransformMatch)EditorGUI.EnumPopup(
                    new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight),
                    tilingRule.m_RandomTransform);
                y += k_SingleLineHeight;
            }

            if (tilingRule.m_Output != RuleMatchSerializable.OutputSprite.Single)
            {
                GUI.Label(new Rect(rect.xMin, y, k_LabelWidth, k_SingleLineHeight)
                    , tilingRule.m_Output == RuleMatchSerializable.OutputSprite.Animation ? Styles.tilingRulesAnimationSize : Styles.tilingRulesRandomSize);
                EditorGUI.BeginChangeCheck();
        ...
        private void HandleDragAndDrop(Rect guiRect)
        {
            ...
            switch (Event.current.type)
            {
                ...
                case EventType.DragPerform:
                {
                    ...
                    Undo.RegisterCompleteObjectUndo(tile, "Drag and Drop to Rule Entity Id Tile");
                    ResizeRuleEntityIdTileList(dragAndDropSprites.Count);
                    for (var i = 0; i < dragAndDropSprites.Count; ++i)
                    {
                        var sprite = dragAndDropSprites[i];
                        tile.m_TilingRules[i].m_Sprites[0] = sprite;
                    }
                    DragAndDropClear();
                    GUI.changed = true;
        ...
        /// <summary>
        ///     Whether the RuleEntityIdTile has a preview GUI
        /// </summary>
        ...
        /// <summary>
        ///     Draws the preview GUI for the RuleEntityIdTile
        /// </summary>
        ...
        /// <summary>
        ///     Creates a Preview for the RuleEntityIdTile.
        /// </summary>
        ...
        /// <summary>
        ///     Renders a static preview Texture2D for a RuleEntityIdTile asset
        /// </summary>
        /// <param name="assetPath">Asset path of the RuleEntityIdTile</param>
        ...
        /// <returns>Texture2D containing static preview for the RuleEntityIdTile asset</returns>
                ...
                if (t != null)
                {
                    ...
                    if (method != null)
                    {
                        var ret = method.Invoke("RenderStaticPreview",
                            new object[] { tile.defaultSprite, Color.white, width, height });
                        if (ret is Texture2D)
        ...
        /// <summary>
        ///     Copies all Rules from a RuleEntityIdTile to the clipboard
        /// </summary>
        /// <param name="item">MenuCommand storing the RuleEntityIdTile to copy from</param>
        [MenuItem("CONTEXT/RuleEntityIdTile/Copy All Rules")]
        public static void CopyAllRules(MenuCommand item)
        {
            var tile = item.context as RuleEntityIdTile;
            if (tile == null)
                return;

            var rulesWrapper = new RuleEntityIdTileRuleWrapper();
        ...
        /// <summary>
        ///     Pastes all Rules from the clipboard to a RuleEntityIdTile
        /// </summary>
        /// <param name="item">MenuCommand storing the RuleEntityIdTile to paste to</param>
        [MenuItem("CONTEXT/RuleEntityIdTile/Paste Rules")]
        ...
        /// <summary>
        ///     Create a RuleEntityIdTile template from this RuleEntityIdTile
        /// </summary>
        /// <param name="item">MenuCommand for creating RuleEntityIdTile template</param>
        [MenuItem("CONTEXT/RuleEntityIdTile/Create RuleEntityIdTile Template")]
        public static void CreateRuleEntityIdTileTemplate(MenuCommand item)
        {
            var tile = item.context as RuleEntityIdTile;
            if (tile == null)
                return;
            ...
            try
            {
                RuleEntityIdTileTemplateUtility.SaveTemplateToFile(tile);
            }
            catch (Exception)
            {
                Debug.LogError("Unable to create a RuleEntityIdTile template from this RuleEntityIdTile");
            }
        }
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent emptyRuleEntityIdTileInfo =
                EditorGUIUtility.TrTextContent(
                    "Drag Sprite or Sprite Texture assets \n" +
                    " to start creating a Rule Entity Id Tile.");
        ...
        /// </summary>
        [Serializable]
        private class RuleEntityIdTileRuleWrapper
        {
            /// <summary>
            ///     List of Rules to serialize
            /// </summary>
            [SerializeField] public List<RuleEntityIdTile.TilingRule> rules = new();
        }
    }
}
