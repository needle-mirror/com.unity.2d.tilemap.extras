...
{
    /// <summary>
    ///     The Editor for an IsometricRuleEntityIdTile.
    /// </summary>
    [CustomEditor(typeof(IsometricRuleEntityIdTile), true)]
    [CanEditMultipleObjects]
    [MovedFrom(true, "UnityEditor.Tilemaps.Experimental", "Unity.2D.Tilemap.Editor.Experimental")]
    public class IsometricRuleEntityIdTileEditor : RuleEntityIdTileEditor
    {
        /// <summary>
        ///     Gets the index for a Rule with the IsometricRuleEntityIdTileEditor to display an arrow.
        /// </summary>
        /// <param name="position">The adjacent position of the arrow.</param>
        /// <returns>Returns the index for a Rule with the IsometricRuleEntityIdTileEditor to display an arrow</returns>
        private static readonly int[] s_Arrows = { 3, 0, 1, 6, -1, 2, 7, 8, 5 };

        /// <summary>
        ///     Gets the index for a Rule with the IsometricRuleEntityIdTile to display an arrow.
        /// </summary>
        /// <param name="position">The adjacent position of the arrow.</param>
        /// <returns>Returns the index for a Rule with the IsometricRuleEntityIdTile to display an arrow.</returns>
        ...
        /// <summary>
        ///     Gets the GUI matrix size for a Rule of a IsometricRuleEntityIdTile
        /// </summary>
        /// <param name="bounds">Cell bounds of the Rule.</param>
        /// <returns>Returns the GUI matrix size for a Rule of a IsometricRuleEntityIdTile.</returns>
        ...
        /// <summary>
        ///     Draws a Rule Matrix for the given Rule for a IsometricRuleEntityIdTile.
        /// </summary>
        ...
        public override void RuleMatrixOnGUI(RuleEntityIdTile tile, Rect rect, BoundsInt bounds, RuleEntityIdTile.TilingRule tilingRule)
        {
        ...
        /// <summary>
        ///     Updates preview settings for the IsometricRuleEntityIdTile.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a Preview for the IsometricRuleEntityIdTile.
        /// </summary>
