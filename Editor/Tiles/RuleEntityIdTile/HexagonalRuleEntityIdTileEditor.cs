...
{
    /// <summary>
    ///     The Editor for a HexagonalRuleEntityIdTile.
    /// </summary>
    [CustomEditor(typeof(HexagonalRuleEntityIdTile), true)]
    [CanEditMultipleObjects]
    [MovedFrom(true, "UnityEditor.Tilemaps.Experimental", "Unity.2D.Tilemap.Editor.Experimental")]
    public class HexagonalRuleEntityIdTileEditor : RuleEntityIdTileEditor
    {
        /// <summary>
        ///     The HexagonalRuleEntityIdTile being edited.
        /// </summary>
        public HexagonalRuleEntityIdTile hexTile => target as HexagonalRuleEntityIdTile;

        /// <summary>
        ///     Gets the index for a Rule with the HexagonalRuleEntityIdTile to display an arrow.
        /// </summary>
        /// <param name="position">The adjacent position of the arrow.</param>
        /// <returns>Returns the index for a Rule with the HexagonalRuleEntityIdTile to display an arrow.</returns>
        ...
        public override BoundsInt GetRuleGUIBounds(BoundsInt bounds, RuleEntityIdTile.TilingRule rule)
        {
        ...
        /// <summary>
        ///     Gets the GUI matrix size for a Rule of a HexagonalRuleEntityIdTile
        /// </summary>
        /// <param name="bounds">Cell bounds of the Rule.</param>
        /// <returns>Returns the GUI matrix size for a Rule of a HexagonalRuleEntityIdTile.</returns>
        ...
        /// <summary>
        ///     Draws a Rule Matrix for the given Rule for a HexagonalRuleEntityIdTile.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a Preview for the HexagonalRuleEntityIdTile.
        /// </summary>
