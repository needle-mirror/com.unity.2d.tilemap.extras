...
namespace UnityEditor.Tilemaps
{
    ...
    internal class AutoEntityIdTileEditorElement : VisualElement
    {
        ...
        private static class Styles
        {
            ...
            public static readonly string maskTypeTooltip = L10n.Tr("Mask Type for setting Rules for the AutoEntityIdTile. Use 2x2 for a 16 Sprite ruleset and 3x3 for a 47 Sprite ruleset.");
                    ...
                    if (template != null)
                    {
                        if ((AutoTile.AutoTileMaskType) autoEntityIdTile.m_MaskType != template.maskType)
                        {
                            throw new InvalidOperationException(
                                $"AutoEntityIdTile Mask '{autoEntityIdTile.m_MaskType}' does not match Template Mask '{template.maskType}'");
                        }
        ...
        {
            // Note: m_AutoEntityIdTile.m_TextureList is increased before this method
        ...
        {
            // Note: m_AutoEntityIdTile.m_TextureList is reduced after this method ends
            int count = 0;
